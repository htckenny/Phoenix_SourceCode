...
#if ground_Test_Mode && enable_stm_COM
...
#if ground_Test_Mode && enable_stm_ANT
#define stm_ant_node 		0x79
#else
#define stm_ant_node 		0x31
#endif
#define ant_arm 			173
...
void secret_command_read(int number, uint8_t *rxbuf);
